...
const columns = [
...

  {
    ...
    key: 'x',
    render: () => <div>
      <Button type='primary' style={{backgroundColor: '#FFC700', marginRight: '5%'}}>Finish</Button>
    </div>
  },
        ...
        <Row>
          ...
          <Col span={20}>
            <div className='deliveries-list'>
              ...
              <Link to='/shipper-panel-ongoing' style={{ margin: '5%', fontSize: '16px', marginRight: '2%', marginLeft: '2%', color: '#A9A9A9'  }}>Ongoing</Link> /
